...
(CAE, QR fiscal, IVA discriminado, leyenda de Transparencia Fiscal) y los mismos ocho datos
por ítem; lo que cambia es cómo se ven, no cuánto dicen (excepto `"simplificada"`, que es
otra cosa -- ver abajo):
