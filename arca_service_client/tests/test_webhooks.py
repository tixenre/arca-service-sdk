...
`apps/arca/tasks.py::deliver_webhook_task` de arca-service (no reimplementado distinto
acá por las dudas — si el esquema real cambia, este test no lo detectaría, pero al menos
confirma que la implementación ES ese esquema)."""
